  ...
  return (
    <>
      ...
      <ScrollArea style={{ height: 450 }} scrollbarSize={8}>
        {usersInfo &&
          usersInfo
            .filter((userInfo) => chat.userID.includes(userInfo.login))
            .map((userInfo, index) => (
                            ...
                            <Group>
                              <ActionIcon
                                onClick={() => {
                                  ...
                                  if(chat.getMute.find((elem) => elem.login === userInfo.login)) {
                                    muteUser(userInfo.login)
                                  } else {
                                    toggleShowTimer();
                                  }
                                }}
                            ...
                            <Group>
                              <ActionIcon
                                onClick={() => {
                                    setContext("BAN");
                                    setUserTo(userInfo.login);
                                    if(chat.getBan.find((elem) => elem.login === userInfo.login)) {
                                      kickUser(userInfo.login);
                                    } else {
                                      toggleShowTimer();
                                    }
                                  }
